        ...
        <Container fluid>
          <Flex direction="column">
            ...
            <Flex w={170} direction="column">
              <Text className={classes.fontStyle} mt={10} ml={20} fz={20} fw={800}>
                {tvDetailsData?.name}
              </Text>
              <Text className={classes.tagline2} mt={10} ml={20}>
                {tvDetailsData?.tagline}
              </Text>
              {/* <Rating initialRating={5} readonly /> */}
              <Flex my={20} justify="space-between" direction="row">
                <Flex direction="column">
                  <Text className={classes.font} fz={15} fw={800}>
                    Language
                  </Text>
                  <Text fz={12}>{tvDetailsData?.spoken_languages[0].english_name}</Text>
                </Flex>
                ...
                <Flex direction="column">
                  ...
                  <Text fz={12}>{tvDetailsData?.status}</Text>
                </Flex>
              </Flex>
              ...
              <Flex direction="column">
                  ...
                  <Text fz={12}>{tvDetailsData?.first_air_date}</Text>
                </Flex>
                <Flex direction="column">
                  <Text className={classes.font} fz={15} fw={800}>
                    Last Air
              ...
              <Flex direction="column">
                ...
                <Flex mt={20} direction="column">
                  ...
                  <Text fz={12} w={220}>{tvDetailsData?.overview}</Text>
                </Flex>
                ...
                <Flex mt={20} direction="column">
                  ...
                  <Grid grow gutter="xl">
                    {tvcIsSuccess &&
                      cast.length !== 0 &&
                      cast?.map((mc: any) => (
                        <Grid.Col key={mc.id} className={classes.cast} span='auto'>
                          {mc.name}
                        </Grid.Col>
                      ))}
                  </Grid>
                ...
                <Flex mt={30} ml={25} direction="row">
                  <Flex direction="column">
                    <a
                      href={tvDetailsData?.homepage}
                      target="_blank"
