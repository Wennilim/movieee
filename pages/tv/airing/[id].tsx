...
import { getTVAiring, getTVPopular } from "../../../api/popularTVAPi";
...
export default function TVAiring() {
  ...
  return (
    <Container>
      ...
      <SimpleGrid cols={6} breakpoints={[{ maxWidth: "xs", cols: 3 }]}>
        {tvAiringIsLoading && <Text>Loading...</Text>}
        {tvAiringIsSuccess &&
          tvAiringData.results.map((tr: any) => (
            <>
              <Card
                key={tr.id}
                p="md"
