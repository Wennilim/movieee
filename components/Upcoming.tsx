  ...
  return (
    <Flex align="flex-start">
      {matchesSmall ? (
        ...
        <Paper shadow="xl" radius="lg" p="md"  mt={30}  ml={{base:-28,lg:30}} w={{ base: 280, xs: 300, sm: 500, lg: 550 }}>
          <Flex align="center" justify="space-between">
            <Flex m={20}>
              <Text className={classes.fontStyle2}>Upcoming</Text>
              <Flex ml="md" align="flex-end">
                <Code color="blue">
                  <Text
                  fz={8}
